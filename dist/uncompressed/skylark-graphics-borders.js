...
define('skylark-graphics-borders/border-color',[
    "skylark-langx/langx",
...
define('skylark-graphics-borders/border-image-outset',[
    "skylark-langx/langx",
    "./borders"
...
define('skylark-graphics-borders/border-image-repeat',[
    "skylark-langx/langx",
    "./borders"
], function(langx,borders) {
...
define('skylark-graphics-borders/border-image-slice',[
    "skylark-langx/langx",
    "./borders"
], function(langx,borders) {
    var _WIDTH_R = /\d+/,
...
define('skylark-graphics-borders/border-image',[
    "skylark-langx/langx",
    "skylark-graphics-brushes/image-brush",
    "./borders",
    "./border-image-outset",
    "./border-image-repeat",
    "./border-image-slice"
...
define('skylark-graphics-borders/border-radius',[
    "skylark-langx/langx",
    "./borders"
], function(langx,borders) {
    var _WIDTH_R = /\d+/,
...
define('skylark-graphics-borders/border-style-type',[
    "skylark-langx/langx",
    "./borders"
], function(langx,borders) {
...
define('skylark-graphics-borders/border-style',[
    "skylark-langx/langx",
    "./borders",
    "./border-style-type"
...
define('skylark-graphics-borders/border-width',[
    "skylark-langx/langx",
    "./borders"
], function(langx,borders) {
